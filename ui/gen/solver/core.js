...
export function createDfsState(startState, options) {
...
export function stepDfsSearch(search, cards, engine, options) {
    ...
    while (search.stack.length > 0 && iterations < iterationLimit) {
        ...
        search.visited += 1;
        if (Number.isFinite(search.maxNodes) &&
        ...
        if (Number.isFinite(search.maxSeen) &&
